...
// ../node_modules/@neoconfetti/react/dist/index.js
...
function Confetti({ class: className, ...options }) {
  const target_ref = (0, import_react.useRef)(null);
  const instance_ref = (0, import_react.useRef)();
  ...
  return (0, import_react.createElement)("div", { ref: target_ref, className });
}
export {
  Confetti
};
//# sourceMappingURL=@neoconfetti_react.js.map
